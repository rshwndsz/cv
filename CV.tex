...
\stitle{Experience} & \bdit{Multi-modal Land-use Classification} \\
    & \textit{Advisor: Prof.\ Biplab Banerjee} \hfill \hspace{-3em} \textit{Jun 2021\ --\ Aug 2021} \\
    & \parbox{0.8\textwidth}{%
        \begin{itemize}[leftmargin=*, itemsep=-0.88ex, topsep=-0.88ex]
            ...
            using vision transformers \& CNNs.
        \end{itemize}
    }
\\
\\
...
\stitle{Skills} & \\[-2.34ex]
                & \parbox{0.8\textwidth}{%
                        \begin{itemize}[leftmargin=0ex, itemsep=-0.4ex, topsep=-2ex, label={}]
                            \item \bdit{Languages}:               Python, Go, C++, SQL, MATLAB, C, JavaScript, Verilog, SPICE 
                            ...
                            \item \bdit{Tools}:                   git, bash, Docker, vim, Linux
...
% Notable projects
\stitle{Notable}  & \bdit{Fashion Discovery for Video Commerce} \hfill \textit{Sep 2021\ --\ Present} \\
\stitle{Projects} & \\[-4ex]
    & \parbox{0.8\textwidth}{%
...
\stitle{Miscellaneous} 
    ...
    %         \item Had to refuse due to conflicts with college schedule, primarily because of COVID-19.
    %     \end{itemize}
    % }
\\
% \\
