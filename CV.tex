...
% Contact Info
% \noindent \begin{longtable}{p{0.15\linewidth} p{0.6\linewidth} rp{0.10\linewidth}}
%     % Address & socials
%     \stitle{Contact}     & \href{https://nitk.ac.in}{National Institute of Technology Karnataka (NITK)}
%                          & \href{mailto:rshwndsz@gmail.com}{rshwndsz@gmail.com}                         \\
...
\noindent \begin{longtable}{@{} p{0.14\linewidth} p{0.8\linewidth}}
    ...
    \stitle{Projects}    &                                                                                                                                                                                                                          \\[-4ex]
        ...
        \begin{itemize}[leftmargin=*, itemsep=-0.88ex, topsep=1.3ex]
            \item Solving the ``\href{https://openaccess.thecvf.com/content_iccv_2015/papers/Kiapour_Where_to_Buy_ICCV_2015_paper.pdf}{Exact street-to-shop}'' problem i.e. matching products in consumer images to those in manufacturer catalogues.
        \end{itemize}
    }                                                                                                                                                                                                                                               \\
                         ...
                         & \parbox{0.8\textwidth}{                                                                                                                                                                                                  %
        \begin{itemize}[leftmargin=*, itemsep=-0.88ex, topsep=1.3ex]
            \item Worked on the design of hardware and software-optimized algorithms to capture vibrant and detailed low-light photos with inexpensive camera sensors.
            \item Worked on model compression algorithms to fit memory and speed constraints.
            \item Built tools for better testing, deployment and to prevent model regressions.
        \end{itemize}
    }                                                                                                                                                                                                                                               \\
