...
\noindent \begin{longtable}{@{} p{0.13\linewidth} p{0.8\linewidth}}
    % Address & socials
    \stitle{Contact}     & 501A, Kirthi Solitaire  \hfill \href{mailto:rshwndsz@gmail.com}{rshwndsz@gmail.com}                                                                                             \\
    \stitle{Information} & Bannanje, Udupi         \hfill \href{https://rshwndsz.github.io}{rshwndsz.github.io}                                                                                            \\
                         & Karnataka, India 576101 \hfill \href{https://github.com/rshwndsz}{\faIcon{github}} \href{https://linkedin.com/in/rshwndsz}{\faIcon{linkedin}} \textcolor{dark-purple}{rshwndsz} \\
    \\
    ...
    \\[-1.5ex]
                         ...
                         & \href{https://nitk.ac.in}{National Institute of Technology Karnataka} \hfill \hspace{-3em} \textsl{2017\ --\ 2021}                                                              \\
    \\[-1.5ex]
                         & {K-12} \hfill \textsl{X: 10.0, XII: 95.6\%}                                                                                                                                     \\
                         & \href{https://littlerock.edu.in}{Little Rock Indian School} \hfill \textsl{2004\ --\ 2017}                                                                                      \\
    \\
    ...
    \stitle{Skills}      &                                                                                                                                                                                 \\[-2.34ex]
        ...
        \begin{itemize}[leftmargin=0ex, itemsep=-0.4ex, topsep=-2ex, label={}]
            ...
            \item \bdit{Web Development}: NodeJS, ExpressJS, postgreSQL
            \item \bdit{Tools}:     git, Docker, bash \& zsh, neo-vim, Linux
            \item \bdit{Hardware}:  Verilog, ngSPICE, Magic VLSI, Xilinx Artix 7 FPGA
        \end{itemize}
    }
    \\
    \\[1ex]
    ...
    %  & \textsl{\href{https://ece.nitk.ac.in/faculty/shyam-lal}{Advisor: Dr Shyam Lal}} \\
        ...
        \begin{itemize}[leftmargin=*, itemsep=-0.88ex, topsep=-0.88ex]
            ...
            \item Worked on the detection of Urothelial Carcinoma from whole slide images, with average dimensions of $80000\times50000$, of bladder tissues.
    ...
    \href{https://cps.iisc.ac.in/}{Robert Bosch Center for Cyber-Physical systems, Indian Institute of Science, Bangalore} (India's top research institute) to work on
