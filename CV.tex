...
\noindent \begin{longtable}{@{} p{0.13\linewidth} p{0.8\linewidth}}
    ...
    %  & \textsl{\href{https://biplab-banerjee.github.io/}{Advisor: Prof Biplab Banerjee}} \\
        ...
        \begin{itemize}[leftmargin=*, itemsep=-0.88ex, topsep=-0.88ex]
            \item Iteratively designed \& developed novel model variants with vision transformers \& CNNs for the multi-modal, pixel-wise classification of land-use from hyperspectral \& LiDAR satellite imagery.
