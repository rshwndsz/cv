...
\noindent \begin{longtable}{@{} p{0.13\linewidth} p{0.8\linewidth}}
    ...
    \stitle{Thesis}      & \href{https://ece.nitk.ac.in/faculty/ramesh-kini-m}{Advisor: Dr Ramesh Kini} \hfill \textsl{Aug 2020\ --\ May 2021}                                                       \\
        ...
        \begin{itemize}[leftmargin=*, itemsep=-0.70ex, topsep=-0.88ex]
            ...
            \item Trained and optimised the network to have just 79416 parameters and require just 5.21 GFlops of compute for a $256\times 256 \times 3$ image.
    ...
    \\[-1.4ex]
                         ...
                         & \parbox{0.8\textwidth}{                                                                                                                                                   %
        \begin{itemize}[leftmargin=*, itemsep=-0.88ex, topsep=0.2ex]
            \item Designed a custom model to classify smart contracts deployed on the Ethereum blockchain into 16 categories using CNNs and stacked auto-encoders, in under 48 hours as a part of a coding sprint.
